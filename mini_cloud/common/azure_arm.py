...
from mini_cloud.common.base import (ConnectionUserAndKey,
                                    JsonResponse,
                                    RawResponse)
from mini_cloud.http import MiniCloudConnection
from mini_cloud.utils.py3 import basestring, urlencode
...
class AzureResourceManagementConnection(ConnectionUserAndKey):
    ...
    def __init__(self, key, secret, secure=True, tenant_id=None,
        ...
        if isinstance(cloud_environment, (basestring, unicode)):
    ...
    def request(self, action, params=None, data=None, headers=None,
        ...
        return super(AzureResourceManagementConnection, self).request(
            action, params=params, data=data, headers=headers,
            method=method, raw=raw, stream=False)

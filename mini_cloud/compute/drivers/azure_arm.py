...
import os
import time
from mini_cloud.common.azure_arm import AzureResourceManagementConnection
from mini_cloud.compute.providers import Provider
from mini_cloud.compute.models import Node, NodeDriver, NodeLocation, NodeSize
from mini_cloud.compute.models import NodeImage, StorageVolume, VolumeSnapshot
from mini_cloud.compute.models import NodeAuthPassword, NodeAuthSSHKey
from mini_cloud.compute.types import NodeState, StorageVolumeState, VolumeSnapshotState
from mini_cloud.common.types import LibcloudError
from mini_cloud.common.exceptions import BaseHTTPError
from mini_cloud.utils.py3 import basestring
from mini_cloud.utils import iso8601
...
class AzureNodeDriver(NodeDriver):
    ...
    def list_locations(self):
        ...
        r = self.connection.async_request(action,
                                    params={"api-version": "2015-01-01"})

        import gevent;gevent.sleep(2)
